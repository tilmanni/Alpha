...
//TODO Class is static (for convenience) should be changed to be instance later.
...
public class PrologModule {
    ...
    public PrologModule(Facts factsFromProgram, AtomStore atomStore) {
    ...
    */
    ...
    public static void addFacts(Facts factsFromProgram) {
    ...
    public static void setAtomStore(AtomStore atomStore) {
        PrologModule.atomStore = atomStore;
    }



    public static void addAtom(Integer atomToAdd) {
        addAtom(atomStore.get(atomToAdd));
    }

    public static void addAtom(at.ac.tuwien.kr.alpha.common.atoms.Atom atomToAdd) {
        long startTime = System.nanoTime();
    ...
    public static void addAtoms(Set<at.ac.tuwien.kr.alpha.common.atoms.Atom> atomsToAdd) {
    ...
    public static void removeAtom(Integer atomToRemove) {
        PrologModule.removeAtom(atomStore.get(atomToRemove));
    }

    public static void removeAtom(at.ac.tuwien.kr.alpha.common.atoms.Atom atomToRemove) {
        long startTime = System.nanoTime();
    ...
    public static void removeAtoms(Set<at.ac.tuwien.kr.alpha.common.atoms.Atom> atomsToRemove) {
    ...
    public static boolean poseQuery(String query) {
        long startTime = System.nanoTime();
    ...
    public static String poseQueryGetResult(String query, String result) {
        long startTime = System.nanoTime();
        Term term = Term.textToTerm(query);
        Query q = new Query(term);
        if (q.hasNext()) {
